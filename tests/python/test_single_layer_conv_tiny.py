...
__all__ = ["test_single_layer_convolution_forward_tiny"]
...
def test_single_layer_convolution_forward_tiny(
    batch_size: int = 1,
    ...
    sparse_dict = generate_feature_map(shape, num_points, IC, dtype=np_dtype, with_dense=use_ref)
